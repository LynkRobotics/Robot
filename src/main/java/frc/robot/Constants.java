...
public final class Constants {
    ...
    public static final class Swerve {
        ...
        public static final class Mod3 { 
            ...
            public static final String canBusID = swerveCanBus;
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(-25.40);
            public static final SwerveModuleConstants constants = 
                new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, canBusID, angleOffset);
        }
    }
    ...
    public static final class Vision {
        ...
        public static final double calibrationFactor =  0.97;
        public static final double calibrationOffset =  0.00; // Lynk HQ
