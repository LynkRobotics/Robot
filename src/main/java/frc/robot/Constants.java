...
public final class Constants {
    ...
    public static final class Vision {
        ...
        public static final double calibrationOffsetBlue = atHQ ? Units.inchesToMeters(0.29) : Units.inchesToMeters(1.0);
        public static final double calibrationFactorRed  = atHQ ? calibrationFactorBlue : 1.0;
        public static final double calibrationOffsetRed  = atHQ ? calibrationOffsetBlue : Units.inchesToMeters(-0.8);
    }
